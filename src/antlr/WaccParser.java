...
public class WaccParser extends Parser {
  ...
  public static class ForStatContext extends StatContext {
    ...
    public TerminalNode FOR() {
      return getToken(WaccParser.FOR, 0);
    }
    ...
    public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
      if (visitor instanceof WaccParserVisitor) {
        return ((WaccParserVisitor<? extends T>) visitor).visitForStat(this);
      } else {
        return visitor.visitChildren(this);
      }
    }
  ...
  public static class VoidReturnStatContext extends StatContext {
    ...
    public VoidReturnStatContext(StatContext ctx) {
      copyFrom(ctx);
    }
    ...
    public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
      if (visitor instanceof WaccParserVisitor) {
        return ((WaccParserVisitor<? extends T>) visitor).visitVoidReturnStat(this);
      } else {
        return visitor.visitChildren(this);
      }
    }
  ...
  public static class AssignStatContext extends StatContext {
	...
	private StatContext stat(int _p) throws RecognitionException {
			...
			enterOuterAlt(_localctx, 1);
      {
        ...
        switch (getInterpreter().adaptivePredict(_input, 7, _ctx)) {
          ...
          _la = _input.LA(1);
          if (((((_la - 19)) & ~0x3f) == 0 &&
              ((1L << (_la - 19)) & ((1L << (NULL - 19)) | (1L << (TRUE - 19)) | (1L << (FALSE
                  - 19)) | (1L << (NOT - 19)) | (1L << (LEN - 19)) | (1L << (ORD - 19)) | (1L << (
                  CHR - 19)) | (1L << (REF - 19)) | (1L << (PLUS - 19)) | (1L << (MINUS - 19)) | (1L
                  << (MULT - 19)) | (1L << (L_PAREN - 19)) | (1L << (NUMBER - 19)) | (1L << (
                  CAPTIALISED_IDENT - 19)) | (1L << (IDENT - 19)) | (1L << (STR_LITER - 19)) | (1L
                  << (CHAR_LITER - 19)))) != 0)) {
            {
              setState(127);
              argList();
	...
	public final AssignRhsContext assignRhs() throws RecognitionException {
				...
				enterOuterAlt(_localctx, 5);
      {
        ...
        _la = _input.LA(1);
        if (((((_la - 19)) & ~0x3f) == 0 &&
            ((1L << (_la - 19)) & ((1L << (NULL - 19)) | (1L << (TRUE - 19)) | (1L << (FALSE - 19))
                | (1L << (NOT - 19)) | (1L << (LEN - 19)) | (1L << (ORD - 19)) | (1L << (CHR - 19))
                | (1L << (REF - 19)) | (1L << (PLUS - 19)) | (1L << (MINUS - 19)) | (1L << (MULT
                - 19)) | (1L << (L_PAREN - 19)) | (1L << (NUMBER - 19)) | (1L << (CAPTIALISED_IDENT
                - 19)) | (1L << (IDENT - 19)) | (1L << (STR_LITER - 19)) | (1L << (CHAR_LITER
                - 19)))) != 0)) {
          {
            setState(208);
            argList();
